...
1) copy the script [ConfigureRemotingForAnsible](https://github.com/lerndevops/ansible/blob/master/windows/ConfigureRemotingForAnsible.ps1) to windows hosts
